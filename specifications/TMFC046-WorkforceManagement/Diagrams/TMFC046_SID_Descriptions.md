# TMFC046 SID Descriptions

Source: `Copy of TMFC046 Workforce Management v1.x.x (TAC-1147) to be used in future versions-v1-Fx_only_source.docx` (Section 2.2) where it documents a definition;
